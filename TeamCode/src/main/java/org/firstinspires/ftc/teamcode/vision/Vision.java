...
public class Vision {
    ...
    public static final double[] camRot2 = {0, 0, 0};
    ...
    public Vision(LinearOpMode opMode, boolean right, boolean front, Side side) {
        this.front = front;
        prop1 = new PropProcessor(right, true, 0.5, 0.3, side);
        tag1 = new TagProcessor(camMat1, camPos1, camRot1);
        //prop2 = new PropProcessor(right, false, 0.3, 0.5, side);
        //tag2 = new TagProcessor(camMat2, camPos2, camRot2);
